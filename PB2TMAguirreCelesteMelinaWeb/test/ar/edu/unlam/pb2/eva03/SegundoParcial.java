...
public class SegundoParcial {
	...
	/*
	 * Suma asegurada: Valor que está en juego. Ante un siniestro es el importe
	 * que la compañía debe abonar ya sea al asegurado o a los beneficiarios
	 * según corresponda.
	 * 
	 * Prima: Importe que el asegurado le paga a la compañía
	 * para contratar el seguro. 
	 * 
	 * Premio: Es la suma de la prima más los
	 * impuestos. 
	 * 
	 * Beneficiario: Son los destinatarios del pago del seguro ante
	 * un siniestro, para el caso de los seguros de vida. Pueden ser mas de uno.
	 * En nuestro ejemplo el pago se divide en partes iguales
	 * premio 0.2
	 */
	@Test
